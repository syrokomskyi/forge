...
const SKIP_DIRS = new Set([
  ...
  ".cache",
  ".agents",
  // Pipeline-managed mission workpieces and archives — their AGENTS.md is
  // generated by the site pipeline, not by forge.agents.generate.
  "missions",
  // Test fixture workshops — not real project workspaces.
  "test-fixtures",
