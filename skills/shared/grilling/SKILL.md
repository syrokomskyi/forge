...
<!--
<MODULE_CONTRACT>
<purpose>grilling skill — Grill the user relentlessly about a plan or design. Use when the user wants to stress-test a plan before building, or uses any 'grill' trigger phrases.</purpose>
<non-goals>
