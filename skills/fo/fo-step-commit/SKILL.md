...
<!--
<MODULE_CONTRACT>
<purpose>fo-step-commit skill — commits agent file changes after each operator request, staging only agent-touched files in monorepo and mission workpiece contexts.</purpose>
<non-goals>
